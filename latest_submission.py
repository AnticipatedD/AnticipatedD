...
──────────────────────────
  ...
  Microsoft Certifications: 90 Badges + 17 Trophies
...
────────────────────────
  ...
  • Microsoft Learn Profile: [MD ABUL HOSSAIN](https://learn.microsoft.com/en-gb/users/mdabulhossain-6486/)
  • IBM Partner Plus Contracts - (Services & Reseller): FISBIVD03SE & FIFVIVUUPT9
  • IBM Software Re-Marketer Customer #: 0004588173
  • IBM Country Enterprise ID: 10wdv2
  
ALPHANOVA PREVIOUS LEADERBOARD STATUS:
──────────────────────────────
...
─────────────────────
  ...
  IBM Relationship: Service & Reseller Business Partner Plus (BPA)
  IBM Service Partnerships Contract Number: FISBIVD03SE 
  IBM Reseller Partnerships contract number: FIFVIVUUPT9
